        ...
        <div class="row row-cols-1 row-cols-md-1 g-4">
            <div class="col">
                <div class="card" style="box-shadow: 5px 5px 10px rgba(135, 110, 210, 0.5);">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold text-uppercase mb-4">Daftar Jadwal Pendaftaran</h5>
                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modaltambah" class="btn btn-primary mt-2">Tambah <i class="ti ti-edit"></i></button>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <form id="formModal" action="{{ route('a.tambah-jadwal-pendaftaran') }}" method="POST">
                                            @csrf
                            ...
                            <tbody>
                                @foreach ($jadwal as $item)
                                    ...
                                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <form action="{{ route('a.update-jadwal-pendaftaran', ['id' => $item->id]) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Jadwal Pendaftaran</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
