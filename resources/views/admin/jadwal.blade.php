                            ...
                            <button type="button" data-bs-toggle="modal" data-bs-target="#modaltambah" class="btn btn-primary mt-2">Tambah <i class="ti ti-edit"></i></button>
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        <form id="formModal" action="{{ route('a.tambah-jadwal') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="judul" value="{{ old('judul') }}" id="judul" required>
                                                    @error('judul')
                            ...
                            <tbody>
                                @foreach ($jadwal as $item)
                                    ...
                                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <form action="{{ route('a.update-jadwal', ['id' => $item->id]) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="form-control @error('judul') is-invalid @enderror"
                                                                name="judul" value="{{ $item->judul }}" id="judul" required>
                                                            @error('judul')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
