...
<ul class="nav nav-tabs justify-content-center fw-semibold" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#PutraRemaja" type="button" role="tab" aria-controls="PutraRemaja" aria-selected="true">Putra</button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#PutriRemaja" type="button" role="tab" aria-controls="PutriRemaja" aria-selected="false">Putri</button>
    </li>
</ul>
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active mt-1" id="PutraRemaja" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
        <div class="row">
            @foreach ($baganPutraRemaja as $item)
    ...
    {{-- PUTRI --}}
    <div class="tab-pane fade mt-1" id="PutriRemaja" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
        <div class="row">
            @foreach ($baganPutriRemaja as $item)
            <div class="col-lg-6 d-flex align-items-stretch">
                <div class="card w-100" style="box-shadow: 5px 5px 10px rgba(135, 110, 210, 0.5);">
                    <div class="card-body p-4">
                        <div class="d-flex">
